...
struct CoreDataFreezerView: View {
  ...
  @FetchRequest(
    ...
    predicate:  NSCompoundPredicate(andPredicateWithSubpredicates: [NSPredicate(format: "onShoppingList == false"), NSPredicate(format: "storageLocation == 'Freezer'")])
  ) var freezer: FetchedResults<GroceryItemEntity>
